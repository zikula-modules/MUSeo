 ...
 * It aims on the extension object type.
 *
 * More documentation is provided in the parent class.
 */
class MUSeo_Form_Handler_Extension_Base_Edit extends MUSeo_Form_Handler_Common_Edit
{
    /**
     * Pre-initialise hook.
     *
    ...
    public function preInitialize()
    {
        ...
        $this->objectTypeCapital = 'Extension';
        $this->objectTypeLower = 'extension';
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        if ($this->mode == 'create') {
            ...
            if (!$modelHelper->canBeCreated($this->objectType)) {
                LogUtil::registerError($this->__('Sorry, but you can not create the extension yet as other items are required which must be created before!'));
    ...
    protected function getDefaultMessage($args, $success = false)
    {
        ...
        switch ($args['commandName']) {
            case 'submit':
                        if ($this->mode == 'create') {
                            $message = $this->__('Done! Extension created.');
                        } else {
                            $message = $this->__('Done! Extension updated.');
                        }
                        break;
            case 'delete':
                        $message = $this->__('Done! Extension deleted.');
                        break;
            default:
                        $message = $this->__('Done! Extension updated.');
                        break;
