 ...
 */
class MUSeo_Api_Base_User extends Zikula_AbstractApi
{
    /**
    ...
    public function encodeurl($args)
    {
        ...
        $routerFacade = new MUSeo_RouterFacade();
        ...
        $allowedObjectTypes = MUSeo_Util_Controller::getObjectTypes('api', $utilArgs);
        $objectType = ((isset($args['args']['ot']) && in_array($args['args']['ot'], $allowedObjectTypes)) ? $args['args']['ot'] : MUSeo_Util_Controller::getDefaultObjectType('api', $utilArgs));
        ...
        $modInfo = ModUtil::getInfoFromName('MUSeo');
