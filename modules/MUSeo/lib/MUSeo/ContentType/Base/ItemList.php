 ...
 */
class MUSeo_ContentType_Base_ItemList extends Content_AbstractContentType
{
    private $objectType;
    private $sorting;
    private $amount;
    ...
    public function getTitle()
    {
        ...
        return __('MUSeo items', $dom);
    }

    public function getDescription()
    {
        $dom = ZLanguage::getModuleDomain('MUSeo');
        return __('Display MUSeo items.', $dom);
    }

    public function loadData(&$data)
    {
        if (!isset($data['objectType']) || !in_array($data['objectType'], MUSeo_Util_Controller::getObjectTypes('contentType'))) {
            $data['objectType'] = MUSeo_Util_Controller::getDefaultObjectType('contentType');
        }
    ...
    public function display()
    {
        ...
        $repository = $entityManager->getRepository('MUSeo_Entity_' . ucfirst($this->objectType));
    ...
    {
        return array('objectType' => 'metatag',
            'sorting'    => 'default',
            'amount'     => 1,
    ...
    {
        $dom = ZLanguage::getModuleDomain('MUSeo');
        array_push($this->view->plugins_dir, 'modules/MUSeo/templates/plugins');
    }
}
