 ...
 */
class MUSeo_Form_Handler_Admin_Metatag_Base_Edit extends MUSeo_Form_Handler_Admin_Edit
{
    /**
    ...
    public function preInitialize()
    {
        ...
        $this->objectTypeLowerMultiple = 'metatags';
    ...
    protected function getDefaultReturnUrl($args, $obj)
    {
        ...
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            // redirect to the detail page of treated metatag
            $url = ModUtil::url($this->name, 'admin', 'display', array('ot' => 'metatag', 'id' => $this->idValues['id']));
        }
        return $url;
    }
