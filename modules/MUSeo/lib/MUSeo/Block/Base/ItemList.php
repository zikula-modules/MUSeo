 ...
 */
class MUSeo_Block_Base_ItemList extends Zikula_Controller_AbstractBlock
{
    /**
    ...
    {
        SecurityUtil::registerPermissionSchema('MUSeo:ItemListBlock:', 'Block title::');
    }
    ...
    public function info()
    {
        ...
        if (!ModUtil::available('MUSeo')) {
            $requirementMessage .= $this->__('Notice: This block will not be displayed until you activate the MUSeo module.');
        }

        return array('module'           => 'MUSeo',
                     'text_type'        => $this->__('Item list'),
                     'text_type_long'   => $this->__('Show a list of MUSeo items based on different criteria.'),
                     'allow_multiple'   => true,
                     'form_content'     => false,
                     'form_refresh'     => false,
                     'show_preview'     => true,
    ...
    public function display($blockinfo)
    {
        ...
        if (!SecurityUtil::checkPermission('MUSeo:ItemListBlock:', "$blockinfo[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        if (!isset($vars['objectType']) || !in_array($vars['objectType'], MUSeo_Util_Controller::getObjectTypes('block'))) {
            $vars['objectType'] = MUSeo_Util_Controller::getDefaultObjectType('block');
        }
        ...
        if (empty($blockinfo['title'])) {
            $blockinfo['title'] = $this->__('MUSeo items');
        }
    ...
    public function update($blockinfo)
    {
        ...
        $vars['objectType'] = $this->request->getPost()->filter('objecttype', 'metatag', FILTER_SANITIZE_STRING);
        ...
        if (!in_array($vars['objectType'], MUSeo_Util_Controller::getObjectTypes('block'))) {
            $vars['objectType'] = MUSeo_Util_Controller::getDefaultObjectType('block');
        }
