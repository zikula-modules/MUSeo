...
{form cssClass='z-form'}
    ...
    <fieldset>
        ...
        <div class="z-formrow">
            ...
            {formtextinput group='module' id='name' mandatory=true readOnly=false __title='Enter the name of the module' textMode='singleline' maxLength=255 cssClass='required validate-unique'}
        ...
        <div class="z-formrow">
            {gt text='Enter the objects of the module comma seperated; for example "album,image"! ' assign='toolTip'}
            {formlabel for='objectsOfModule' __text='Objects of module' mandatorysym='1' class='museoFormTooltips' title=$toolTip}
            {formtextinput group='module' id='objectsOfModule' mandatory=true readOnly=false __title='Enter the objects of module of the module' textMode='singleline' maxLength=100 cssClass='required'}
            {museoValidationError id='objectsOfModule' class='required'}
        </div>
        <div class="z-formrow">
            {gt text='Enter the name of the identifier for this module; for example "id"!' assign='toolTip'}
            {formlabel for='nameOfIdentifier' __text='Name of identifier' mandatorysym='1' class='museoFormTooltips' title=$toolTip}
            {formtextinput group='module' id='nameOfIdentifier' mandatory=true readOnly=false __title='Enter the name of identifier of the module' textMode='singleline' maxLength=255 cssClass='required'}
