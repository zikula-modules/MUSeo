...
class MUSeo_Entity_Validator_Base_Metatag extends MUSeo_Validator
{
    ...
    public function validateAll()
    {
        ...
        if (!$this->isStringNotLongerThan('stringOfObject', 50)) {
            $errorInfo['message'] = __f('Error! Length of field value must not be higher than %2$s (%1$s).', array('stringOfObject', 50), $dom);
            return $errorInfo;
        }
        if (!$this->isStringNotLongerThan('extraInfos', 255)) {
            $errorInfo['message'] = __f('Error! Length of field value must not be higher than %2$s (%1$s).', array('extraInfos', 255), $dom);
            return $errorInfo;
        }
        return true;
    }
