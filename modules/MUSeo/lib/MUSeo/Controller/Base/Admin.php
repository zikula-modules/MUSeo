 ...
 */
class MUSeo_Controller_Base_Admin extends Zikula_AbstractController
{
    /**
     * Post initialise.
     *
    ...
    public function main($args)
    {
        ...
        $this->throwForbiddenUnless(SecurityUtil::checkPermission('MUSeo::', '::', ACCESS_ADMIN));
    ...
    public function view($args)
    {
        ...
        $repository = $this->entityManager->getRepository('MUSeo_Entity_' . ucfirst($objectType));
        ...
        if ($tpl == 'tree') {
            ...
            return MUSeo_Util_View::processTemplate($this->view, 'admin', $objectType, 'view', $args);
        }
    ...
    public function display($args)
    {
        ...
        $idValues = MUSeo_Util_Controller::retrieveIdentifier($this->request, $args, $objectType, $idFields);
        $hasIdentifier = MUSeo_Util_Controller::isValidIdentifier($idValues);
        ...
        // fetch and return the appropriate template
        return MUSeo_Util_View::processTemplate($this->view, 'admin', $objectType, 'display', $args);
    }
    ...
    public function edit($args)
    {
        ...
        $handlerClass = 'MUSeo_Form_Handler_Admin_' . ucfirst($objectType) . '_Edit';
    ...
    public function delete($args)
    {
        ...
        // fetch and return the appropriate template
        return MUSeo_Util_View::processTemplate($this->view, 'admin', $objectType, 'delete', $args);
    }
    ...
    public function config()
    {
        ...
        // Execute form using supplied template and page event handler
        return $view->execute('admin/config.tpl', new MUSeo_Form_Handler_Admin_Config());
    }
}
