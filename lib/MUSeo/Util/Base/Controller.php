 ...
 */
class MUSeo_Util_Base_Controller extends Zikula_AbstractBase
{
    /**
     * Returns an array of all allowed object types in MUSeo.
     *
    ...
    public function getObjectTypes($context = '', $args = array())
    {
        ...
        $allowedObjectTypes[] = 'metatag';
        $allowedObjectTypes[] = 'extension';
    
        return $allowedObjectTypes;
    }

    /**
     * Returns the default object type in MUSeo.
     *
     * @param string $context Usage context (allowed values: controllerAction, api, actionHandler, block, contentType, util).
     * @param array  $args    Additional arguments.
     *
    ...
    public function getFileBaseFolder($objectType, $fieldName, $ignoreCreate = false)
    {
        ...
        $basePath = FileUtil::getDataDirectory() . '/MUSeo/';
        ...
        switch ($objectType) {
            case 'metatag':
                ...
                switch ($fieldName) {
                    case 'facebookImage':
                        $basePath .= 'facebookimage/';
                        break;
                    case 'twitterImage':
                        $basePath .= 'twitterimage/';
                        break;
                    case 'googlePlusImage':
                        $basePath .= 'googleplusimage/';
                        break;
                }
            break;
        }
    ...
    public function checkAndCreateAllUploadFolders()
    {
        ...
        $result &= $this->checkAndCreateUploadFolder('metatag', 'facebookImage', 'gif, jpeg, jpg, png');
        $result &= $this->checkAndCreateUploadFolder('metatag', 'twitterImage', 'gif, jpeg, jpg, png');
        $result &= $this->checkAndCreateUploadFolder('metatag', 'googlePlusImage', 'gif, jpeg, jpg, png');
    ...
    protected function checkAndCreateUploadFolder($objectType, $fieldName, $allowedExtensions = '')
    {
        ...
        $htaccessFileTemplate = 'modules/MUSeo/docs/htaccessTemplate';
