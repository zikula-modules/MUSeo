...
function mUMUSeoReadDate(val, includeTime)
{
 ...
 */
function mUMUSeoUniqueCheck(ucOt, val, elem, ucEx)
{
    var params, request;
    ...
    request = new Zikula.Ajax.Request(
        Zikula.Config.baseURL + 'ajax.php?module=MUSeo&func=checkForDuplicate',
        {
            method: 'post',
            parameters: params,
            authid: 'FormAuthid',
...
function mUMUSeoValidateNoSpace(val)
{
    var valStr;
...
function mUMUSeoValidateUploadExtension(val, elem)
{
 ...
 */
function mUMUSeoAddCommonValidationRules(objectType, id)
{
    Validation.addAllThese([
        ['validate-nospace', Zikula.__('No spaces', 'module_museo_js'), function(val, elem) {
            return mUMUSeoValidateNoSpace(val);
        }],
        ['validate-upload', Zikula.__('Please select a valid file extension.', 'module_museo_js'), function(val, elem) {
            return mUMUSeoValidateUploadExtension(val, elem);
        }],
        ['validate-unique', Zikula.__('This value is already assigned, but must be unique. Please change it.', 'module_museo_js'), function(val, elem) {
            return mUMUSeoUniqueCheck('mUSeo', val, elem, id);
        }]
    ]);
}
