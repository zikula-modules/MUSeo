 ...
 */
class MUSeo_Form_Handler_Common_Base_Edit extends Zikula_Form_AbstractHandler
{
    /**
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        $controllerHelper = new MUSeo_Util_Controller($this->view->getServiceManager());
    ...
    protected function writeRelationDataToEntity_rec($entity, $entityData, $plugins)
    {
        foreach ($plugins as $plugin) {
            if ($plugin instanceof MUSeo_Form_Plugin_AbstractObjectSelector && method_exists($plugin, 'assignRelatedItemsToEntity')) {
    ...
    {
        foreach ($plugins as $plugin) {
            if ($plugin instanceof MUSeo_Form_Plugin_AbstractObjectSelector && method_exists($plugin, 'persistRelatedItems')) {
