 ...
 */
class MUSeo_Form_Handler_Admin_Module_Base_Edit extends MUSeo_Form_Handler_Admin_Edit
{
    /**
    ...
    public function preInitialize()
    {
        ...
        $this->objectTypeCapital = 'Module';
        $this->objectTypeLower = 'module';
        $this->objectTypeLowerMultiple = 'modules';
    ...
    protected function getDefaultReturnUrl($args, $obj)
    {
        ...
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            // redirect to the detail page of treated module
            $url = ModUtil::url($this->name, 'admin', 'display', array('ot' => 'module', 'id' => $this->idValues['id']));
        }
        return $url;
    }
    ...
    protected function getDefaultMessage($args, $success = false)
    {
        ...
        switch ($args['commandName']) {
            case 'create':
                $message = $this->__('Done! Module created.');
                break;
            case 'update':
                $message = $this->__('Done! Module updated.');
                break;
            case 'update':
                $message = $this->__('Done! Module deleted.');
                break;
        }
        return $message;
    }
