...
/**
 * The museoGetFileSize modifier displays the size of a given file in a readable way.
 *
 ...
 */
function smarty_modifier_museoGetFileSize($size = 0, $filepath = '', $nodesc = false, $onlydesc = false)
{
    if (!is_numeric($size)) {
        $size = (int) $size;
    }
    ...
    $viewHelper = new MUSeo_Util_View($serviceManager);
