 ...
 */
class MUSeo_Base_UploadHandler
{
    /**
    ...
    {
        $this->allowedObjectTypes = array('metatag');
        ...
        $this->allowedFileSizes = array('metatag' => array('facebookImage' => 0, 'twitterImage' => 0, 'googlePlusImage' => 0));
    }
