 ...
 */
class MUSeo_Form_Handler_Admin_Base_Edit extends Zikula_Form_AbstractHandler
{
    /**
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        $this->idValues = MUSeo_Util_Controller::retrieveIdentifier($this->request, array(), $this->objectType, $this->idFields);
        $hasIdentifier = MUSeo_Util_Controller::isValidIdentifier($this->idValues);
    ...
    public function HandleCommand(Zikula_Form_View $view, &$args)
    {
        ...
        $hookAreaPrefix = 'museo.ui_hooks.' . $this->objectTypeLowerMultiple;
