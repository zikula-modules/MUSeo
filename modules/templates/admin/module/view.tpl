...
<table class="z-datatable">
    ...
    <tr>
        ...
        <th id="hobjectsofmodule" scope="col" class="z-left">
            {sortlink __linktext='Objects of module' sort='objectsOfModule' currentsort=$sort sortdir=$sdir all=$all modname='MUSeo' type='admin' func='view' ot='module'}
        </th>
    ...
    <tr class="{cycle values='z-odd, z-even'}">
        ...
        <td headers="hobjectsofmodule" class="z-left">
            {$module.objectsOfModule}
        </td>
