{* purpose of this template: metatags delete confirmation view in admin area *}
...
<div class="z-admin-content-pagetitle">
    ...
    <form class="z-form" action="{modurl modname='MUSeo' type='admin' func='delete' ot='metatag' id=$metatag.id}" method="post">
        <div>
            ...
            <fieldset>
                ...
                <div class="z-buttons z-formbuttons">
                    ...
                    <a href="{modurl modname='MUSeo' type='admin' func='view' ot='metatag'}">{icon type='cancel' size='small' __alt='Cancel' __title='Cancel'} {gt text='Cancel'}</a>
                </div>
            </fieldset>
