 ...
 */
class MUSeo_Api_Base_Cache extends Zikula_AbstractApi
{
    /**
    ...
    public function clearItemCache(array $args = array())
    {
        ...
        $view = Zikula_View::getInstance('MUSeo');
        ...
        $cacheIds[] = 'MUSeo/user/main'; // main function
        switch ($objectType) {
            case 'metatag':
                $cacheIdPrefix = 'MUSeo/' . $objectType . '/';
