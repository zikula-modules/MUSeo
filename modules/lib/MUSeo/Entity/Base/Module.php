...
abstract class MUSeo_Entity_Base_Module extends Zikula_EntityAccess
{
     ...
     * @var string $objectsOfModule.
     */
    protected $objectsOfModule = '';
    ...
    /**
     * Get objects of module.
     *
     * @return string
     */
    public function getObjectsOfModule()
    {
        return $this->objectsOfModule;
    }

    /**
     * Set objects of module.
     *
     * @param string $objectsOfModule.
     *
     * @return void
     */
    public function setObjectsOfModule($objectsOfModule)
    {
        if ($objectsOfModule != $this->objectsOfModule) {
            $this->objectsOfModule = $objectsOfModule;
        }
    }
    ...
    if ($currentFunc != 'edit') {
        $this['objectsOfModule'] = ((isset($this['objectsOfModule']) && !empty($this['objectsOfModule'])) ? DataUtil::formatForDisplayHTML($this['objectsOfModule']) : '');
    }
    if ($currentFunc != 'edit') {
