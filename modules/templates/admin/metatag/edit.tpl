...
{form cssClass='z-form'}
    ...
    <fieldset>
        ...
        <div class="z-formrow">
            ...
            {formlabel for='title' __text='Title' mandatorysym='1' class='museoFormTooltips' title=$toolTip}
            {formtextinput group='metatag' id='title' mandatory=true readOnly=false __title='Enter the title of the metatag' textMode='singleline' maxLength=255 cssClass='required'}
            {museoValidationError id='title' class='required'}
        </div>
        <div class="z-formrow">
        ...
        <div class="z-formrow">
            ...
            {formtextinput group='metatag' id='theModule' mandatory=true readOnly=false __title='Enter the the module of the metatag' textMode='singleline' maxLength=50 cssClass='required'}
