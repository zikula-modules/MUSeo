...
/**
 * The museoObjectState modifier displays the name of a given object's workflow state.
 * Examples:
 *    {$item.workflowState|museoObjectState}       {* with visual feedback *}
 *    {$item.workflowState|museoObjectState:false} {* no ui feedback *}
 *
 ...
 */
function smarty_modifier_museoObjectState($state = 'initial', $uiFeedback = true)
{
