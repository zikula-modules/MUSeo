 ...
 */
class MUSeo_Form_Plugin_Base_ItemSelector extends Zikula_Form_Plugin_TextInput
{
    /**
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            PageUtil::addVar('javascript', 'modules/MUSeo/javascript/MUSeo_finder.js');
            PageUtil::addVar('stylesheet', ThemeUtil::getModuleStylesheet('MUSeo'));
        }
        $firstTime = false;

        if (!SecurityUtil::checkPermission('MUSeo:' . ucfirst($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }

        $this->selectedItemId = $this->text;

        $entityClass = 'MUSeo_Entity_' . ucfirst($this->objectType);
        ...
        $view = Zikula_View::getInstance('MUSeo', false);
    ...
    {
        parent::decode($view);
        $this->objectType = FormUtil::getPassedValue('MUSeo_objecttype', 'metatag', 'POST');
        $this->selectedItemId = $this->text;
    }
}
