 ...
 */
class MUSeo_Util_Base_View extends Zikula_AbstractBase
{
    /**
    ...
    public static function availableExtensions($type, $objectType, $func, $args = array())
    {
        $extParams = array();
        if ($func == 'view') {
            if (SecurityUtil::checkPermission('MUSeo::', '::', ACCESS_ADMIN)) {
    ...
    protected static function processPdf(Zikula_View $view, $template)
    {
        ...
        $fileTitle = MUSeo_Util_Controller::formatPermalink(System::getVar('sitename'))
            . '-'
            . MUSeo_Util_Controller::formatPermalink(PageUtil::getVar('title'))
            . '-' . date('Ymd') . '.pdf';
