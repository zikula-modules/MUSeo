 ...
 *
 * This is the base entity class for extension entities.
 ...
 * @abstract
 */
abstract class MUSeo_Entity_Base_Extension extends Zikula_EntityAccess
{
    /**
     * @var string The tablename this object maps to.
     */
    protected $_objectType = 'extension';
    
    /**
     * @var MUSeo_Entity_Validator_Extension The validator for this entity.
     */
     ...
     * Get _validator.
     *
     * @return MUSeo_Entity_Validator_Extension
     */
     ...
     * Set _validator.
     *
     * @param MUSeo_Entity_Validator_Extension $_validator.
     *
     * @return void
     */
    public function set_validator(MUSeo_Entity_Validator_Extension $_validator = null)
    {
     ...
     *
     * @see MUSeo_Entity_Extension::postLoadCallback()
    ...
    protected function performPostLoadCallback()
    {
        ...
        $this->formatTextualField('controllerForView', $currentFunc, $usesCsvOutput);
        $this->formatTextualField('controllerForSingleObject', $currentFunc, $usesCsvOutput);
        $this->formatTextualField('parameterForObjects', $currentFunc, $usesCsvOutput);
        $this->formatTextualField('nameOfIdentifier', $currentFunc, $usesCsvOutput);
        $this->formatTextualField('extraIdentifier', $currentFunc, $usesCsvOutput);
     ...
     *
     * @see MUSeo_Entity_Extension::prePersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no access to entity manager or unit of work apis
     *
     * @see MUSeo_Entity_Extension::postPersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see MUSeo_Entity_Extension::preRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL DELETE statement
     *
     * @see MUSeo_Entity_Extension::postRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no creation of other entities allowed
     *
     * @see MUSeo_Entity_Extension::preUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL UPDATE statement
     *
     * @see MUSeo_Entity_Extension::postUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see MUSeo_Entity_Extension::preSaveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     * For more information see corresponding callback handlers.
     *
     * @see MUSeo_Entity_Extension::postSaveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @return MUSeo_Entity_Validator_Extension The validator for this entity.
     */
    public function initValidator()
    {
        ...
        $this->_validator = new MUSeo_Entity_Validator_Extension($this);
    ...
    protected function prepareItemActions()
    {
        ...
        $currentFunc = FormUtil::getPassedValue('func', 'main', 'GETPOST', FILTER_SANITIZE_STRING);
        $component = 'MUSeo:Extension:';
        $instance = $this->id . '::';
        $dom = ZLanguage::getModuleDomain('MUSeo');
        if ($currentLegacyControllerType == 'admin') {
            if (in_array($currentFunc, array('main', 'view'))) {
                $this->_actions[] = array(
                    'url' => array('type' => 'user', 'func' => 'display', 'arguments' => array('ot' => 'extension', 'id' => $this['id'])),
                    'icon' => 'preview',
                    'linkTitle' => __('Open preview page', $dom),
                    'linkText' => __('Preview', $dom)
                );
                $this->_actions[] = array(
                    'url' => array('type' => 'admin', 'func' => 'display', 'arguments' => array('ot' => 'extension', 'id' => $this['id'])),
                    'icon' => 'display',
            ...
            if (in_array($currentFunc, array('main', 'view', 'display'))) {
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_EDIT)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'extension', 'id' => $this['id'])),
                        'icon' => 'edit',
                        'linkTitle' => __('Edit', $dom),
                        'linkText' => __('Edit', $dom)
                    );
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'extension', 'astemplate' => $this['id'])),
                        'icon' => 'saveas',
                ...
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_DELETE)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'delete', 'arguments' => array('ot' => 'extension', 'id' => $this['id'])),
                        'icon' => 'delete',
            ...
            if ($currentFunc == 'display') {
                $this->_actions[] = array(
                    'url' => array('type' => 'admin', 'func' => 'view', 'arguments' => array('ot' => 'extension')),
                    'icon' => 'back',
        ...
        if ($currentLegacyControllerType == 'user') {
            ...
            if (in_array($currentFunc, array('main', 'view', 'display'))) {
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_EDIT)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'user', 'func' => 'edit', 'arguments' => array('ot' => 'extension', 'id' => $this['id'])),
                        'icon' => 'edit',
                        'linkTitle' => __('Edit', $dom),
                        'linkText' => __('Edit', $dom)
                    );
                    $this->_actions[] = array(
                        'url' => array('type' => 'user', 'func' => 'edit', 'arguments' => array('ot' => 'extension', 'astemplate' => $this['id'])),
                        'icon' => 'saveas',
                        'linkTitle' => __('Reuse for new item', $dom),
                        'linkText' => __('Reuse', $dom)
                    );
                ...
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_DELETE)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'user', 'func' => 'delete', 'arguments' => array('ot' => 'extension', 'id' => $this['id'])),
                        'icon' => 'delete',
                        'linkTitle' => __('Delete', $dom),
                        'linkText' => __('Delete', $dom)
                    );
            ...
            if ($currentFunc == 'display') {
                $this->_actions[] = array(
                    'url' => array('type' => 'user', 'func' => 'view', 'arguments' => array('ot' => 'extension')),
                    'icon' => 'back',
                    'linkTitle' => __('Back to overview', $dom),
                    'linkText' => __('Back to overview', $dom)
                );
    ...
    {
        return 'museo.ui_hooks.extensions';
    }
